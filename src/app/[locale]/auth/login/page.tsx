        ...
        <main className="cm-main" style={{ margin: '0 auto', maxWidth: 500 }}>
          <div className="cm-content-box text-center">
            ...
            <p className="text-gray-500 my-4">
              {locale === 'es'
                ? 'El inicio de sesión está desactivado por ahora. El admin se accede directamente desde la URL.'
                : 'Login is currently disabled. Admin is accessed directly via URL.'}
            </p>
