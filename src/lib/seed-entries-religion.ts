...
Christianity grew despite Roman persecution until Emperor Constantine legalized the religion with the Edict of Milan (313 AD). Theodosius I made it the official religion of the Roman Empire (380 AD). Ecumenical councils (Nicaea 325, Chalcedon 451) defined Trinitarian and Christological doctrine. Christianity split in 1054 between the Roman Catholic and Eastern Orthodox churches. Today it is the world's largest religion with approximately 2.4 billion followers.`,
    excerpt_es: 'De una secta judía a la religión más grande del mundo: historia del cristianismo.', excerpt_en: 'From a Jewish sect to the world's largest religion: history of Christianity.', categoryId: 'cat-christianity', realityStatus: 'historical', imageUrl: '', createdAt: now, updatedAt: now },
...
Buddhism divides into three main branches: Theravada (the tradition of the elders, predominant in Sri Lanka and Southeast Asia), Mahayana (Great Vehicle, in China, Japan, and Korea), and Vajrayana (Tantric or Tibetan Buddhism). Buddhism teaches non-violence, compassion (karuna), mindfulness, and the impermanence of all things. It has approximately 500 million followers worldwide.`,
    excerpt_es: 'El camino del despertar: las enseñanzas de Buda, las Cuatro Nobles Verdades y el Óctuple Sendero.', excerpt_en: 'The path of awakening: the Buddha's teachings, the Four Noble Truths, and the Eightfold Path.', categoryId: 'cat-buddhism', realityStatus: 'historical', imageUrl: '', createdAt: now, updatedAt: now },
...
The LDS Church is characterized by belief in ongoing revelation, practice of baptism for the dead, eternal marriage, the Word of Wisdom (health code prohibiting alcohol and caffeine), and missionary work. Headquartered in Salt Lake City, Utah, it has approximately 17 million members. Mormonism is one of the most successful and fastest-growing new religious movements.`,
  ...
  { id: 'entry-bahai', title_es: 'Fe Baháʼí', title_en: 'Baháʼí Faith', slug: 'fe-bahai',
    content_es: `La Fe Baháʼí es una religión monoteísta fundada por Baháʼu'lláh (1817-1892) en la Persia del siglo XIX. Enseña la unidad espiritual de toda la humanidad, la unidad de las religiones y la unidad de la humanidad como un solo pueblo. Surgió del babismo, un movimiento religioso persa fundado por el Báb (1819-1850).

Los principios baháʼís incluyen la creencia en un solo Dios, la unidad fundamental de todas las religiones (cada tradición revela una parte de la verdad divina), la igualdad de hombres y mujeres, la eliminación de los prejuicios raciales y religiosos, la armonía entre ciencia y religión, la educación universal y el establecimiento de una comunidad mundial basada en la paz.

Baháʼu'lláh escribió extensamente, incluyendo el Kitáb-i-Aqdas (el libro más sagrado). El centro administrativo mundial baháʼí está en Haifa, Israel, en el Monte Carmelo. No tiene clero; la comunidad se organiza a través de asambleas espirituales elegidas. La Fe Baháʼí tiene aproximadamente 8 millones de seguidores en todo el mundo, distribuidos en más de 200 países, lo que la convierte en una de las religiones más diversas geográficamente.`,
    content_en: `The Baháʼí Faith is a monotheistic religion founded by Baháʼu'lláh (1817-1892) in 19th-century Persia. It teaches the spiritual unity of all humanity, the unity of religions, and the unity of humankind as one people. It emerged from Babism, a Persian religious movement founded by the Báb (1819-1850).

Baháʼí principles include belief in one God, the fundamental unity of all religions (each tradition reveals a part of divine truth), equality of women and men, elimination of racial and religious prejudice, harmony of science and religion, universal education, and establishment of a world community based on peace.

Baháʼu'lláh wrote extensively, including the Kitáb-i-Aqdas (the most holy book). The Baháʼí world administrative center is in Haifa, Israel, on Mount Carmel. It has no clergy; the community is organized through elected spiritual assemblies. The Baháʼí Faith has approximately 8 million followers worldwide, spread across more than 200 countries, making it one of the most geographically diverse religions.`,
    excerpt_es: 'La religión de la unidad: Baháʼu'lláh, la paz mundial y la armonía entre ciencia y fe.', excerpt_en: 'The religion of unity: Baháʼu'lláh, world peace, and harmony between science and faith.', categoryId: 'cat-new-religions', realityStatus: 'historical', imageUrl: '', createdAt: now, updatedAt: now },
]
